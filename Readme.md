...
2. [🏠 Overview Page (Survey Overview)](#-overview-page-survey-overview)
3. [🔗 Project Links](#-project-links)
4. [📊 General Survey Analysis Page](#-general-survey-analysis-page)
5. [📈 Specialized Analysis Pages](#-specialized-analysis-pages)
6. [🔧 Technical Implementation Details](#-technical-implementation-details)
7. [📊 Data Quality Standards](#-data-quality-standards)
8. [🚀 Usage Guide](#-usage-guide)
9. [📁 Project File Structure](#-project-file-structure)
10. [🧭 Beginner Deployment Guide](#-beginner-deployment-guide)

    * [1. Prerequisites](#1-prerequisites)
    * [2. Local Setup](#2-local-setup)
    * [3. Page Structure](#3-page-structure-within-the-running-app)
    * [4. Uploading from Local to GitHub](#4-uploading-from-local-to-github)
    * [5. Deploying to Streamlit Cloud](#5-deploying-to-streamlit-cloud)
    * [6. Troubleshooting](#6-troubleshooting)
11. [🪄 YEAP Dashboard Title Modification Guide](#-yeap-dashboard-title-modification-guide)
